...
if (! extension_loaded('intl')) {
    ...
    $message = sprintf(
        'This project must run with a PHP build that has the intl extension enabled. Current PHP: %s. Install or enable intl for the PHP runtime serving this app. For local artisan usage, you can also set BUSTERTERMINAL_PHP_BINARY to a compatible PHP binary%s.',
        PHP_VERSION,
        $preferredPhpBinary ? sprintf(' (%s)', $preferredPhpBinary) : ''
    );
